...
import com.nguyenvanhoang.application.model.dto.CheckPromotion;
...
import com.nguyenvanhoang.application.model.request.CreateOrderBulkRequest;
import com.nguyenvanhoang.application.service.*;
import com.nguyenvanhoang.application.entity.*;
...
import com.nguyenvanhoang.application.model.request.CreateOrderRequest;
...
public class HomeController {
    ...
    @PostMapping("/api/orderscart")
    public ResponseEntity<Object> createOrderBulk(@Valid @RequestBody CreateOrderBulkRequest bulkRequest) {
        User user = ((CustomUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getUser();
        List<Order> orders = new ArrayList<>();
        for (CreateOrderRequest orderRequest : bulkRequest.getOrders()) {
            Order order = orderService.createOrder(orderRequest, user.getId());
            orders.add(order);
        }
    ...
    public String cartItem(){ return "redirect:/shopping-cart/views"; }
